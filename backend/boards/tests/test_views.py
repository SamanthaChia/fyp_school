...
class TestBoardDetailView:
    ...
    def test_put(self, make_board):
        ...
        assert (response.data['title'] ==
                "testing board" and response.data['description'] == "testing"), "Should be edited"
        user1 = mixer.blend(User)
        client.force_authenticate(user1)
        response = client.put('/boards/1/',
                              {"title": "testing board",
...
class TestListDetailView:
    ...
    def test_put(self, make_list):
        ...
        assert response.status_code == 200 and response.data['title'] == "testing"
        client.force_authenticate(user1)
        response = client.put('/boards/lists/1/',
                              {
                                  "title": "testing1"
                              })
        assert response.status_code == 200 and response.data['title'] == "testing1"
        client.force_authenticate(user2)
        response = client.put('/boards/lists/1/',
                              {
                                  "title": "testing2"
...
class TestCommentDetailView:
    ...
    def test_put(self, make_comment):
        ...
        response = client.put('/boards/comments/1/',
                              {
                                  "body": "Personal board comment has been edited"
                              })
        assert response.status_code == 200 and response.data["body"] == "Personal board comment has been edited"
        ...
        response = client.put('/boards/comments/3/',
                              {
                                  "body": "Board comment has been edited"
                              })
        assert response.status_code == 200 and response.data["body"] == "Board comment has been edited"
        client.force_authenticate(user_member)
        response = client.put('/boards/comments/1/',
                              {
                                  "body": "Personal board comment has been edited"
        ...
        response = client.put('/boards/comments/2/',
                              {
                                  "body": "Board comment has been edited by a member of group"
                              })
        ...
        response = client.put('/boards/comments/1/',
                              {
                                  "body": "Personal comment has been edited"
                              })
        assert response.status_code == 403
        response = client.put('/boards/comments/2/',
                              {
        ...
        response = client.put('/boards/comments/3/',
                              {
                                  "body": "Board comment has beene dited"
                              })
        assert response.status_code == 403
...
class TestLabelDetailView:
    def test_put(self):
        ...
        assert response.data["title"] == "LabelName"
