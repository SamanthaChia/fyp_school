...
from .models import Attachment, Board, Comment, Item, Label, Leaderboard, List, Notification
from .permissions import CanViewBoard, IsAuthorOrReadOnly
from .serializers import (AttachmentSerializer, BoardSerializer,
                          CommentSerializer, ItemSerializer, LabelSerializer, LeaderboardSerializer,
...
class LeaderboardList(generics.ListCreateAPIView):
    ...
    def get_queryset(self, *args, **kwargs):
        ...
        board = self.get_board(board_id)
        return Leaderboard.objects.filter(board=board)
