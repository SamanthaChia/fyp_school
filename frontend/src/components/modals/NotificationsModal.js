            ...
            <div className="label-modal__content">
                ...
                {notificationsToShow.length === 0 && (
                    <div className="label-modal__no-notif">
                        <img src={nonotif} alt="no Notification" style={{width: "100px", height:"100px"}} />
...
const appendTargetTitleVerbs = [
    "has assigned you to task",
    "gave you admin permission of",
];
...
const iconMap = {
    "has assigned you to task": "fal fa-user-plus",
    "gave you admin permission of": "fal fa-arrow-up",
