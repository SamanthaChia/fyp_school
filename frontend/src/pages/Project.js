...
const Project = (props) => {
    ...
    const [boardProject, setBoardProject] = useState(id); // If 0, we are making a personal board. Else, making board for project with given ID
            ...
            <div className="team__body">
                {curTab === 1 && (
                    <div>
                        ...
                        >
                            <i className="fal fa-plus"></i> Create a Board
                        </button>
